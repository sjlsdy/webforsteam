				...
				<div class="home-content-topic-info-box">
					...
					<div class="home-game-more">
						<div class="home-game-live-box">
							<div class="home-game-live">601,128 playing right now</div>
						</div>
					...
					<div class="home-gameinfo-box">
						...
						<div class="home-gameinfo-item">
							...
							<div class="home-friendsplaying-frame">
								<div class="home-friendsplaying-title">
									4 friends playing right now
								</div>
...
<script>
	export default {
		...
		methods: {
			...
			changeCanvas() {
				let _this = this;
				let bodyWidth = document.documentElement.clientWidth <= 1080 ? 1080 : document.documentElement.clientWidth;
